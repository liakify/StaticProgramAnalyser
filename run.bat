...
call "C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" /Parallel Team06/Code06/Debug/UnitTesting.dll 

echo.
echo ######################## RUNNING INTEGRATION TESTS ########################
call "C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe" /Parallel Team06/Code06/Debug/IntegrationTesting.dll

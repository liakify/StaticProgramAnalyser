...
public:
	...
	// If proc is not in the ProcTable, proc is inserted into the ProcTable. Else, the table remains unchanged.
	...
	// Returns the procedure object at the given ID in the ProcTable. Throws an exception if the ID is not found in the table.

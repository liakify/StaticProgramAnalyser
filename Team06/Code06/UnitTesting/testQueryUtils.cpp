	...
	TEST_CLASS(TestQueryUtils) {
		public:
			...
			vector<string> VALID_PATTERNS = {
				...
				// " _\"var\"_  ", "_  \"b0th / S1des\" _", " _\"asymmetr1C \" _", " _ \" 3230 %   D *c - b+a\"_"
			};
			...
			vector<pair<string, string>> LEFT_TRIM_PAIRS = {
			...
			vector<pair<string, string>> RIGHT_TRIM_PAIRS = {
				{ EMPTY_STRING, EMPTY_STRING },
				{ "test", "test" },
				{ "right ", "right" },
			...
			vector<pair<string, string>> TRIMMED_STRING_PAIRS = {
				{ EMPTY_STRING, EMPTY_STRING },
			...
			vector<pair<string, string>> STRIPPED_PATTERN_PAIRS = {
				{ EMPTY_STRING, EMPTY_STRING },
				{ "\"x\"", "x" },
			...
			vector<pair<pair<string, char>, pair<string, string>>> SPLIT_STRING_PAIRS = {
			...
			vector<pair<pair<string, char>, vector<string>>> TOKENISED_STRING_PAIRS = {
				{ { EMPTY_STRING, ' ' }, { } },
				{ { "no_space", ' ' }, { "no_space" } },
